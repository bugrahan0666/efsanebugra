...
await 
  ...
  return  await(message.reply('Erkek olarak başarıyla kayıt ettim!').then(msg => msg.delete(5000)).then(kanal1.send(embed).then(kanal.send(embed1).then(msg => msg.delete(12000)))));
};
exports.conf = {
  enabled: true,
  guildOnly: true,
